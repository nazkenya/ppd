    ...
    <div className="bg-background min-h-screen pb-24 flex flex-col">
      <div className="p-6 bg-white sticky top-0 z-10 shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-lg font-bold font-heading">Konfirmasi Pesanan</h1>
        </div>
      </div>
      ...
      <div className="p-6 space-y-6 flex-1 overflow-y-auto">
        ...
        <div className="bg-muted p-1 rounded-xl flex">
          <button className="flex-1 py-2 rounded-lg bg-primary text-primary-foreground font-bold text-sm shadow-sm">Antar</button>
          <button className="flex-1 py-2 rounded-lg text-muted-foreground font-medium text-sm">Ambil</button>
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className="p-4 border border-border rounded-2xl bg-white">
             ...
             <div className="flex gap-2">
               <Button variant="outline" size="sm" className="h-8 text-xs rounded-lg">Ubah Alamat</Button>
               <Button variant="outline" size="sm" className="h-8 text-xs rounded-lg">Tambah Catatan</Button>
             </div>
          </div>
        </div>
        ...
        <div className="space-y-2 pt-2">
          <h3 className="font-bold text-sm">Ringkasan Pembayaran</h3>
         ...
         <div className="flex justify-between items-center mb-4 p-3 bg-muted/50 rounded-xl cursor-pointer">
          <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-xs font-bold">Tunai/Dompet</span>
                <span className="text-[10px] text-primary font-bold">Rp 55.000</span>
              </div>
            </div>
            <ChevronRight size={16} className="text-muted-foreground" />
         </div>
         <Button className="w-full h-12 rounded-xl text-lg font-bold shadow-lg">Pesan</Button>
      </div>
    </div>
  );
}
